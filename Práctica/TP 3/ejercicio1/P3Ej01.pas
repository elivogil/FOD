...
begin
    writeln('');
    writeln('Ingresar numero de empleado a eliminar:');
    readln(num);
    leer(arc,e);
    while(e.num<>corte)and(e.num<>num)do
        leer(arc,e);
    if(e.num=corte)then begin
        writeln('');
...
procedure subMenu();
    ...
    begin
        ...
        writeln('Presione "8" si desea eliminar a un empleado');
        writeln('Presione "9" para salir del archivo');
        readln(num);
    end;
